    ...
    },
    {
      ...
      categories: [
        ...
        },
        {
          title: 'Grill Sides',
          items: [
            { name: 'Dodo (Fried Plantain)', description: 'Crispy fried plantain', price: 6.99, image: '/images/boli.png' },
      ...
      categories: [
        {
          ...
          items: [
            ...
            { name: 'Shawarma + Fries Combo', description: 'Chicken shawarma wrap paired with a regular fries', price: 13.99, image: '/images/shawarmafriescombo.jpg' },
            { name: 'Mini Bites Platter', description: 'Akara, moi moi and spicy dip for sharing', price: 11.99, image: '/images/Akara.jpg' },
          ],
        },
        {
          title: 'Drinks',
