...
const MealPlan = () => {
  ...
  return (
    <Box sx={{ minHeight: '100vh', bgcolor: '#f8f8f6' }}>
      <Seo title="My AI Meal Plan | HoneySpice Cuisine" description="Your personalised 7-day Nigerian meal plan, generated by Claude AI based on your health profile and dietary goals." />
      {/* Hero */}
      <Box
        sx={{
          position: 'relative',
      ...
      >
        <Container maxWidth="lg" sx={{ position: 'relative', zIndex: 3, textAlign: 'center' }}>
          ...
          <Typography sx={{ color: 'rgba(255,255,255,0.85)', mt: 1 }}>
            Personalised Nigerian nutrition, powered by Claude AI
          </Typography>
        </Container>
      </Box>
      ...
      <Container maxWidth="lg" sx={{ py: 4 }}>
        ...
        {!loading && !plan && (
          <Box sx={{ textAlign: 'center', py: 8 }}>
            ...
            <Typography sx={{ color: '#666', mb: 3 }}>Generate your personalised AI meal plan from the Dashboard</Typography>
            <button
